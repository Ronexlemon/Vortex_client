...
import styles from "./../styles/Spin.module.css"; // Import scoped styles
...
></canvas>
      ...
      {showPrizeModal && (
        <div className={`${styles.modal} ${styles.isActive}`}>
          <div className={styles.modalBackground}></div>
          <div className={styles.modalContent}>
            <div className={styles.box}>
              <h1 className={styles.prizeTitle}>{prizeName}</h1>
            </div>
          </div>
          <button
      ...
      {showInstructionsOverlay && (
        <div className={styles.instructionsOverlay}>
          <div className={styles.instructionBox}>Follow the instructions...</div>
        </div>
      )}
    </div>
  );
